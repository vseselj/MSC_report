...
\begin{center}
 \begin{tabular}{||c|c||} 
 \hline
 Indeks tachke medju 68 karakteristichnih tachaka & Indeks verteksau $3D$ modelu\\[0.5ex]
 \hline\hline
 49 & 398\\
 \hline
 50 & 315\\
...
\end{tabular}
\end{center}
\caption{Prikaz mapiranja karakteristichnih tachaka usta na $3D$ model}
\label{tab:3_1}
\end{table}
\newpage
\begin{figure}[h!]
\centering
  ...
  \caption{Prikaz izabranih verteksa}
  \label{fig:2_9}
  \vspace{0pt}
\end{figure}
