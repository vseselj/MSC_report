...
U ovom poglavlju c1e se prvo baciti kratak osrt na klasichne neuralne mrezhe, a zatim c1e biti detaljnije obradjen pojam razlichitih vrsta rekurentnih neuralnih mrezha.

\section{Klasichne neuralne mrezhe}
...
\end{equation}
Chesti izbori aktivacione funckije su sigmoid $\sigma(z)=1/(1+e^{-z})$ i hiperbolichki tangens $\tanh(z) = (e^z-e^{-z})/(e^z-e^{-z})$. Od skora, u modelima dubokih neuralnih mrezha, aktivaciona funkcija $ReLU(z)=max(0,z)$ koja je pokazala znachajno poboljshanje performansi.
