...
\section[$LSTM$ model]{$\mathbf{LSTM}$ modeli}
U ovom delu bic1e prikazani razultati obuchavanja \acrshort{LSTM} modela. Parametar koji varira je dimenzija stanja c1elije $n$ u intervalu od 20 do 150. Prvobitno je pokushano sa jednim slojem skrivenih rekuretnih \acrshort{LSTM} c1elija, a kasnije je vidjen performas i visheslojnih mrezha.
\newpage
\begin{figure}[!h]
        \centering
        \begin{subfigure}{0.475\textwidth}
...
\begin{figure}[!h]
        ...
        \begin{subfigure}{0.475\textwidth}
            ...
            \vspace{0pt}
        \end{subfigure}
        \caption{Jednoslojna \acrshort{LSTM} mrezha sa $n=120$}
        \label{fig:4_4}
\end{figure}
\begin{figure}[!h]
        \centering
