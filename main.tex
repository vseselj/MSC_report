...
itemc/.style={item,on chain,join}]
 ...
 \path node (A0) {$\mathbf{h}^0$} node (A1) {$\mathbf{h}^{1}$} node (A2) {$\mathbf{h}^{2}$} node[xshift=2em] (At){$\mathbf{h}^{3}$};
 \end{scope}
...
\begin{tikzpicture}[item/.style={circle,draw,thick,align=center}]
 ...
 \draw[very thick,-latex, color=blue!60](y.east) to (s.north);
 ...
 \draw [very thick,-latex, color=blue!60] (2,1.54) to (3,1.54);
\end{tikzpicture}
\vspace{0pt}
...
\begin{tikzpicture}[item/.style={circle,draw,thick,align=center}]
 ...
 \draw[very thick,-latex, color=blue!60](AL.east) to [out=60,in=120](s.west);
 \node[text width=4cm] at (5,2)(t1) {rekurentna veza};
 \draw [very thick,-latex,dotted] (2,2.05) to (3,2.05);
 \node[text width=4cm] at (5,1.5)(t2) {$\mathbf{W}=1$};
 \draw [very thick,-latex, color=blue!60] (2,1.54) to (3,1.54);
...
\label{fig:11}
\end{figure}
\subsection{Obuchavanje rekurentnih neuralnih mrezha}
...
\subsection{Moderne rekurentne neuralne mrezhe} 
