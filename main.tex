...
\begin{figure}[!h]
        ...
        \begin{subfigure}{0.475\textwidth}
            ...
            \vspace{0pt}
        \end{subfigure}
        \caption{Prikaz detektovanih karakteristichnih lica nad frejmovima videa $Weekly\ Address$: $A\ Balanced\ Approach\ to\ Growing\ the\ Economy\ in\ 2013$}
        \label{fig:2_3}
\end{figure}
\section{$\mathbf{3D}$ model lica}
