...
\newpage
\printglossary[title=Skrac1enice, toctitle=Lista skrac1enica, type=\acronymtype]
...
\begin{figure}[!h]
        ...
        \begin{subfigure}{0.475\textwidth}
            \centering
            \includegraphics[scale=0.21]{res/168lm.jpg}
            \caption{168. frejm}
            \label{fig:2_5a}
            \vspace{0pt}
        \end{subfigure}%
        \begin{subfigure}{0.475\textwidth}
            \centering
            \includegraphics[scale=0.21]{res/169lm.jpg}
            \caption{169. frejm}
            \label{fig:2_5b}
            \vspace{0pt}
        \end{subfigure}
        ...
        \begin{subfigure}{0.475\textwidth}
            \centering
            \includegraphics[scale=0.21]{res/170lm.jpg}
            \caption{170. frejm}
            \label{fig:2_5c}
            \vspace{0pt}
        \end{subfigure}%
...
\end{equation}
za oblik, gde je $M\le n-1$ je broj principjalnih komponenti i $\mathbf{\alpha}in\mathbb{R}^{M}$ su $3D$ koordinate nove instance u $PCA$ prostoru. Slichan metod se mozhe primeniti i za boju (albedo).\\
$SFM$ je izgradjen na velikom broju $3D$ skenova visoke rezolucije lica ljudi razlhite starosne dobi i razlhite boje kozhe. Vazhan podatak je da se u samom setu najmanje najmanje tamnoputih lica (oko $5\%$), ali zbog neposedovanja drugih $3DMM$ modela, odlucheno je da se ostane pri $SFM$. 
\begin{figure}[h!]
\centering
...
\begin{figure}[!h]
        ...
        \begin{subfigure}{0.475\textwidth}
            \centering
            \includegraphics[scale=0.25]{res/170_3D.jpg}
            \caption{170. frejm}
            \label{fig:2_7c}
            \vspace{0pt}
        \end{subfigure}%
        \begin{subfigure}{0.475\textwidth}
            \centering
            \includegraphics[scale=0.25]{res/171_3D.jpg}
            \caption{171. frejm}
            \label{fig:2_7d}
            \vspace{0pt}
        \end{subfigure}
